          ...
          >
            ...
            {cartItems.length > 0 ? (
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm mb-3">
                            <div>
                              ...
                              <span className="ml-2 font-medium text-gray-900">{item.fabric}</span>
                            </div>
                            <div>
                  ...
                  <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
                    ...
                    <div className="pt-4 border-t border-gray-200 mb-6">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-2xl font-bold text-blue-600">₹{total.toFixed(0).toLocaleString()}</span>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full mt-3 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors font-medium"
                    >
                      Continue Shopping
                    </button>
                  </div>
              ...
              <div className="text-center py-12 bg-white rounded-lg shadow-md">
                ...
                <p className="text-gray-600 mb-6">Add items from our catalogue to get started</p>
                <button
                  onClick={() => navigate('/customer/catalogue')}
