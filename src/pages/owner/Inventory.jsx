          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 mt-2">Track and manage your stock items</p>
              </div>
              <motion.button
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <motion.div whileHover={{ scale: 1.02 }} className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-500 text-sm">Total Fabric</p>
                <p className="text-2xl font-bold text-green-600 mt-2">{totalFabricQuantity}m</p>
              </motion.div>
            </div>
                        ...
                        <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            {item.quantity === 0 ? (
                              ...
                              <span className="px-3 py-1 rounded-full text-xs font-semibold bg-orange-100 text-orange-700 flex items-center gap-1 w-fit">
                                <AlertTriangle className="w-3 h-3" />
                                Low Stock
                              </span>
                            ) : (
                  ...
                  <div className="space-y-2">
                    {inventoryItems.filter(item => item.quantity <= item.minStock && item.quantity > 0).map(item => (
                      <div key={item.id} className="flex justify-between items-center p-2 bg-orange-50 rounded">
                        ...
                        <span className="text-sm text-orange-600">{item.quantity} {item.unit}</span>
                      </div>
                    ))}
                  ...
                  <div className="space-y-2">
                    {inventoryItems.slice(0, 5).map((item, index) => (
                      <div key={item.id} className="flex justify-between items-center p-2 bg-blue-50 rounded">
                        ...
                        <span className="text-sm text-blue-600">{Math.floor(Math.random() * 100)} uses</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 ${errors.name ? 'border-red-500' : 'border-gray-300'}`}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 ${errors.category ? 'border-red-500' : 'border-gray-300'}`}
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 ${errors.unit ? 'border-red-500' : 'border-gray-300'}`}
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 ${errors.quantity ? 'border-red-500' : 'border-gray-300'}`}
                      placeholder="0"
                      min="0"
                    />
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Minimum Stock Alert Level</label>
                    <input
                      type="number"
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-2">Upload Item Photo</label>
                    {!photoPreview ? (
          ...
          >
            ...
            >
              <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-2xl">
                ...
                <button onClick={() => { setShowEditModal(false); setEditingItem(null); resetForm(); }} className="p-2 hover:bg-gray-100 rounded-lg">
                  <X className="w-6 h-6 text-gray-600" />
                </button>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-xl font-bold text-gray-900">${selectedItem.purchasePrice}</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <p className="text-sm text-gray-600 mb-1">Last Updated</p>
                    <p className="text-xl font-bold text-gray-900">{selectedItem.lastUpdated}</p>
                  </div>
                </div>
