              ...
              <div className="p-4 border-b border-gray-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Chat with owner & team</p>
                  </div>
                </div>
                ...
                <AnimatePresence>
                  {isTyping && (
                    ...
                    >
                      ...
                      <span className="text-xs text-gray-500">Owner is typing...</span>
                    </motion.div>
                  )}
                </AnimatePresence>
                    ...
                    <AnimatePresence>
                      {showEmojiPicker && (
                        <motion.div
                          ...
                          className="absolute bottom-full mb-2 left-0 bg-white rounded-lg shadow-xl border border-gray-200 p-3 z-50"
                        >
