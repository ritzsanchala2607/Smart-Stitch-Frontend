        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Track your performance and analytics</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                <h2 className="text-xl font-bold text-gray-900 mb-6">Weekly Task Timeline</h2>
              ...
              <motion.div
                ...
                className="bg-white rounded-lg shadow-md p-6"
              >
                <h2 className="text-xl font-bold text-gray-900 mb-6">Monthly Workload</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                <div className="p-6 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    <h2 className="text-xl font-bold text-gray-900">Error/Redo Tasks</h2>
                ...
                <div className="p-6">
                  {errorTasks.length > 0 ? (
                        ...
                        >
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-semibold text-gray-900">{error.id}</span>
                            </div>
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600">No errors or redo tasks!</p>
              ...
              >
                <div className="p-6 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    <h2 className="text-xl font-bold text-gray-900">Worker Rankings</h2>
                    <Trophy className="w-6 h-6 text-yellow-500" />
                  </div>
                  <p className="text-sm text-gray-600 mt-1">Based on completion rate & quality</p>
                </div>
                <div className="p-6">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1">
                                <span className={`font-semibold ${
                                  isCurrentWorker ? 'text-purple-900' : 'text-gray-900'
                                }`}>
                                  {worker.name}
                                </span>
                                {isCurrentWorker && (
    ...
    <div className="space-y-4">
      ...
      <div className="relative h-64">
        ...
        <div className="flex justify-between mt-2">
          {data.map((d, i) => (
            <span key={i} className="text-xs text-gray-600">{d.week}</span>
          ))}
        </div>
      </div>
    </div>
          ...
          return (
            <div key={index} className="flex-1 flex flex-col items-center gap-2">
              <div className="w-full flex flex-col items-center h-56">
                <span className="text-sm font-semibold text-gray-700 mb-2">{month.completed}</span>
